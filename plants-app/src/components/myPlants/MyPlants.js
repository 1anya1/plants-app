        ...
        <div className="hero intro" id="my-plants">
          <div className="content">
            ...
            <div className="subtitle">
              List all of your plants and keep track of their progress
            </div>
          </div>
        ...
        <div className="intro my-plants">
          ...
          <form onSubmit={this.handleSubmit} id="add-plant">
            ...
            {this.state.image_uploaded && (
              <button id="active" placeholder="submit" type="submit">
                {" "}
                Add Plant
              </button>
            )}
          ...
          <div className="plants-list" id="plants">
            ...
            <div className="row">
              ...
              {plants < 1 && <h4>Sorry, but you do not have any entries</h4>}
            </div>
          </div>
          {this.state.update && (
            <UpdatePlant
          ...
          <div className="all-plants" id="manage-plants">
            <div className="accordion" onClick={this.expand}>
              <div className="title">
                <h4 className={this.state.toggle ? "translate" : null}>
                  ManagePlants
                </h4>
              ...
              <div
                className={
                  this.state.toggle ? "plantsManage show" : "plantsManage hide"
                }
              >
                {this.state.plants.map((el, idx) => {
                  return (
                    <div className="plant" key={idx}>
                      <h5>{el.title}</h5>
                      <button
                        id="delete"
                        value={el.id}
