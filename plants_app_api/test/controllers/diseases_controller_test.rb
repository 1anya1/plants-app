...
class DiseasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create disease" do
    assert_difference('Disease.count') do
      post diseases_url, params: { disease: { findThem: @disease.findThem, img: @disease.img, name: @disease.name, treatment: @disease.treatment } }, as: :json
    end
  ...
  test "should update disease" do
    patch disease_url(@disease), params: { disease: { findThem: @disease.findThem, img: @disease.img, name: @disease.name, treatment: @disease.treatment } }, as: :json
    assert_response 200
  end
